...
class TimelinesControllerTest < ActionController::TestCase
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post :create, timeline: { event: @timeline.event, event_date: @timeline.event_date, notes: @timeline.notes, who: @timeline.who }
    end
  ...
  test "should update timeline" do
    patch :update, id: @timeline, timeline: { event: @timeline.event, event_date: @timeline.event_date, notes: @timeline.notes, who: @timeline.who }
    assert_redirected_to timeline_path(assigns(:timeline))
  end
